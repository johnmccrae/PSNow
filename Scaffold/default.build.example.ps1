...
Task Default WhereAmI, Build, Pester, Publish
...
Task WhereAmI {
    Write-Output "I am located at: "$moduleRoot
}
...
## this task pulls all your .ps1 files together and puts them into a .psm1 file
