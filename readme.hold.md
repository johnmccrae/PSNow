...
This project was generated using code, support, and guidance (whether they know it or not) from:
[Kevin Marquette](http://kevinmarquette.github.io)'s [Full Module Plaster Template](https://github.com/KevinMarquette/PlasterTemplates/tree/master/FullModuleTemplate).
[Adam Rush](https://adamrushuk.github.io/example-azure-devops-build-pipeline-for-powershell-modules/#test-1)
Doug Finke
Warren F - Rambking Cookie Monster
